...
import { CONFIG, DOSHA_SYMPTOMS, PRAKRITI_SPECIFIC_ADVICE } from "@/lib/config";
import {
  calculateDoshaImbalance,
  getAdjustedSeverity,
...
const DISEASE_INFO = {
  Gastritis: {
    sanskrit: "Amlapitta",
    description:
      "A digestive disorder characterized by burning sensation and acidity.",
  ...
  Migraine: {
    ...
    symptoms:
      "Throbbing headache, sensitivity to light, nausea, visual disturbances",
    lifestyle: [
...
function App() {
  ...
  const [seasonal, setSeasonal] = useState(getSeasonalRecommendations());
  ...
  const handlePredict = async () => {
    ...
    try {
      const imbalance = calculateDoshaImbalance(symptom, prakriti);

      const currentSeasonal = getSeasonalRecommendations();
      setSeasonal(currentSeasonal);

      const adjustedSeverity = getAdjustedSeverity(severity, prakriti);

      const symptomMatchesPrakriti = isPrioritySymptom(symptom, prakriti);
      ...
      console.log(" Enhanced payload with 12 features:", payload);
      ...
      data.constitutional_analysis = {
        ...
        seasonal_advice: currentSeasonal.advice,
        symptom_matches_prakriti: symptomMatchesPrakriti,
      ...
      const historyEntry = {
        ...
        imbalancedDosha: imbalance.imbalanced_dosha,
        season: currentSeasonal.season,
      };
  ...
  return (
    <Box sx={{ bgcolor: "background.default", minHeight: "100vh", py: 4 }}>
      <Container maxWidth="lg">
              ...
              <Card sx={{ mb: 3 }}>
                <CardContent>
                  ...
                  <Alert severity="info" sx={{ mb: 2 }}>
                    <strong>What is Prakriti?</strong>
                    <br />
                    Your unique body constitution determined by Vata, Pitta, and
                    Kapha balance.
                  </Alert>
                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={12}>
                      <FormControl component="fieldset">
                        <FormLabel>
                          <strong>Mental Activity</strong>
                        </FormLabel>
                        <RadioGroup
                          row
                          value={mentalActivity}
                          onChange={(e) => setMentalActivity(e.target.value)}
                        >
                          <FormControlLabel
                            value="Restless/Active"
                            control={<Radio />}
                            label="Restless"
                          />
                          <FormControlLabel
                    ...
                    <Grid container spacing={2}>
                      ...
                      <Grid item xs={4}>
                        ...
                        >
                          <Typography
                            variant="h4"
                            sx={{ color: "#4ecdc4", fontWeight: 700 }}
                          >
                      ...
                      <Grid item xs={4}>
                        ...
                        >
                          <Typography
                            variant="h4"
                            sx={{ color: "#45b7d1", fontWeight: 700 }}
                          >
                ...
                <>
                  ...
                  >
                    <CardContent>
                      ...
                      <Typography
                        variant="h3"
                        sx={{ color: "#0d47a1", fontWeight: 700, my: 2 }}
                      >
                    ...
                    <CardContent>
                      ...
                      {DISEASE_INFO[prediction.predicted_disease] && (
                        <>
                          ...
                          <Typography variant="body1" paragraph>
                            <strong>Dosha Involvement:</strong>{" "}
                            {DISEASE_INFO[prediction.predicted_disease].dosha}
                          </Typography>
                          <Typography variant="body1" paragraph>
                          ...
                          <Alert severity="warning" sx={{ my: 2 }}>
                            ...
                            <br />
                            These are general recommendations. Please consult a
                            qualified Ayurvedic practitioner for personalized
                ...
                >
                  <CardContent sx={{ textAlign: "center" }}>
                    ...
                    <Typography variant="h5" color="text.secondary">
                      Fill in the form and click "Predict Disease" to see
                      results
                    </Typography>
                  </CardContent>
                </Card>
        ...
        {prediction && prediction.constitutional_analysis && (
          <Card sx={{ mb: 3 }}>
            <CardContent>
              <Typography
                variant="h5"
              ...
              <Alert severity="info" sx={{ mb: 2 }}>
                <strong>Analysis based on your {prakriti} constitution</strong>
              </Alert>
              ...
              <Grid container spacing={2}>
                <Grid item xs={12} md={6}>
                  <Card sx={{ bgcolor: "#fff3e0", p: 2 }}>
                    ...
                    >
                      {prediction.constitutional_analysis.imbalanced_dosha}
                    </Typography>
                  </Card>
                </Grid>
                ...
                <Grid item xs={12} md={6}>
                  <Card sx={{ bgcolor: "#e3f2fd", p: 2 }}>
                    ...
                    >
                      {prediction.constitutional_analysis.season}
                    </Typography>
                  </Card>
                </Grid>
                ...
                <Grid item xs={12}>
                  <Alert severity="success" icon={false}>
                    <Typography variant="body2">
                      <strong>Seasonal Advice:</strong>{" "}
                      {prediction.constitutional_analysis.seasonal_advice}
                    </Typography>
                  </Alert>
                </Grid>

                {prediction.constitutional_analysis
                  .symptom_matches_prakriti && (
                  <Grid item xs={12}>
                    <Alert severity="success">
                      ✓ This symptom is commonly associated with your {prakriti}{" "}
                      constitution
                    </Alert>
                  </Grid>
                )}

                {prediction.constitutional_analysis.adjusted_severity !==
                  prediction.constitutional_analysis.original_severity && (
                  <Grid item xs={12}>
                    <Alert severity="info">
                      Severity adjusted based on your Prakriti tendency to{" "}
                      {prakriti.includes("Vata")
                        ? "over-report"
                        : "under-report"}{" "}
                      symptoms
                    </Alert>
        ...
        {/* Prakriti-Specific Advice Card - NEW */}
        {prediction &&
          prakriti &&
          PRAKRITI_SPECIFIC_ADVICE[prakriti.split("-")[0].toLowerCase()] && (
            <Card sx={{ mb: 3 }}>
              <CardContent>
                <Typography
                  variant="h5"
                  ...
                  sx={{ display: "flex", alignItems: "center", gap: 1 }}
                >
                  ✨ Personalized for Your {prakriti} Constitution
                </Typography>
                <Divider sx={{ mb: 2 }} />

                <Alert severity="info" sx={{ mb: 3 }}>
                  These recommendations are tailored to your constitutional type
                </Alert>
                ...
                >
                  <Spa sx={{ color: "primary.main" }} /> General Lifestyle
                  Guidelines:
                </Typography>
                <Box component="ul" sx={{ pl: 3 }}>
                  {PRAKRITI_SPECIFIC_ADVICE[
                    prakriti.split("-")[0].toLowerCase()
                  ].general.map((advice, i) => (
                    <li key={i}>
                ...
                {PRAKRITI_SPECIFIC_ADVICE[prakriti.split("-")[0].toLowerCase()][
                  ...
                  <>
                    ...
                    >
                      <LocalHospital sx={{ color: "success.main" }} /> Specific
                      for {prediction.predicted_disease}:
                    </Typography>
                    <Box component="ul" sx={{ pl: 3 }}>
                      {PRAKRITI_SPECIFIC_ADVICE[
                        prakriti.split("-")[0].toLowerCase()
                      ][prediction.predicted_disease.toLowerCase()].map(
                        (advice, i) => (
                          <li key={i}>
                            <Typography variant="body2" paragraph>
                              {advice}
              ...
              <Card>
                <CardContent>
                  ...
                  <Typography paragraph>
                    This AI-powered system integrates traditional Ayurvedic
                    principles with modern machine learning to predict diseases
                    based on:
                  </Typography>
                  <ul>
                    <li>
                      <Typography>Patient symptoms</Typography>
                    </li>
                    <li>
                      <Typography>Constitutional type (Prakriti)</Typography>
                    </li>
                    <li>
                      <Typography>
                    ...
                    <li>
                      <Typography>Individual characteristics</Typography>
                    </li>
                  </ul>
                  ...
                  <ol>
                    <li>
                      <Typography>
                        <strong>Gastritis</strong> (Amlapitta) - Digestive
                        disorder
                      </Typography>
                    </li>
                    <li>
                      <Typography>
                        <strong>Arthritis</strong> (Amavata) - Joint
                        inflammation
                      </Typography>
                    </li>
                    <li>
                      <Typography>
                        <strong>Diabetes</strong> (Prameha) - Metabolic disorder
                      </Typography>
                    </li>
                    <li>
                      <Typography>
                        <strong>Migraine</strong> (Ardhavabhedaka) - Severe
                        headache
                      </Typography>
                    </li>
                    <li>
                      <Typography>
                        <strong>Asthma</strong> (Shwasa) - Respiratory condition
                      </Typography>
                    </li>
                  </ol>
                </CardContent>
            ...
            <Grid item xs={12} md={6}>
              <Card sx={{ mb: 3 }}>
                <CardContent>
                  ...
                  <Typography paragraph>
                    <strong>Training Data:</strong> 1,000 patients, 2,992
                    records
                  </Typography>
                  <Typography paragraph>
                    <strong>Features:</strong> 9 constitutional + symptom
                    features
                  </Typography>
                  <Typography paragraph>
                  ...
                  <Typography paragraph>
                    <strong>Novelty:</strong> First ML system integrating
                    Prakriti assessment
                  </Typography>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent>
                  ...
                  <Alert severity="success" sx={{ mt: 2 }}>
                    <strong>Improvement over symptom-only approach:</strong>{" "}
                    ~10%
                  </Alert>
                </CardContent>
              </Card>
                    ...
                    <TableBody>
                      {predictionHistory.map((item, index) => (
                        <TableRow key={index}>
                          ...
                          <TableCell>
                            <strong>{item.predictedDisease}</strong>
                          </TableCell>
                          <TableCell>
                            <Chip
            ...
            <Grid item xs={12}>
              <Card>
                <CardContent>
                  ...
                  <Typography paragraph>
                    Fill in basic details like age, gender, and location. This
                    helps in demographic analysis.
                  </Typography>
                  ...
                  <Typography paragraph>
                    Answer 6 simple questions about body type, skin, appetite,
                    sleep, mental activity, and temperament. The system will
                    automatically calculate your Vata, Pitta, and Kapha scores.
                  </Typography>
                  ...
                  <Typography paragraph>
                    Select the primary symptom from the dropdown, choose the
                    severity level, and enter how long you've had the symptom.
                  </Typography>
                  ...
                  <Typography paragraph>
                    Click the "Predict Disease" button. The AI will analyze your
                    symptoms along with constitutional factors and provide a
                  ...
                  <Typography paragraph>
                    See top 3 possible diseases, read about the predicted
                    disease, and review general recommendations. Always consult
                    an Ayurvedic practitioner for confirmation.
                  </Typography>
                </CardContent>
              </Card>
            </Grid>
            ...
            <Grid item xs={12}>
              <Card>
                <CardContent>
                  ...
                  <Typography paragraph>
                    Prakriti is your unique body constitution determined at
                    birth. It's based on the balance of three doshas (Vata,
                    Pitta, Kapha) and influences your physical, mental, and
                  ...
                  <Typography paragraph>
                    The system achieves 84.2% accuracy on test data. However,
                    it's designed as a screening tool and should not replace
                  ...
                  <Alert severity="error" sx={{ my: 1 }}>
                    <strong>No.</strong> This system is for educational and
                    research purposes only. Always consult a qualified Ayurvedic
                    practitioner for proper diagnosis and treatment.
                  </Alert>
                  ...
                  <Typography paragraph>
                    This is the first ML system that integrates constitutional
                    awareness (Prakriti) with symptom analysis, showing ~10%
                    improvement over symptom-only approaches.
                  </Typography>
                  ...
                  <Typography paragraph>
                    Predictions are stored only in your current browser session
                    for the history feature. No data is permanently stored or
                    shared.
                  </Typography>
                </CardContent>
              </Card>
